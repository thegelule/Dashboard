...
function DisplayTemplateChoiceUI(character){
    ...
    bootbox.prompt({
        ...
        callback: function (result) {
            ...
            CSSinclude[0].href = "Templates/" + result + "/" + result + ".css";
            $.ajax({
...
function createPDF(docName){
    ...
    $(".Page2").css("padding-top","150px"); //html2canvas crops the first top 200px-ish. No idea why...
...
function printElem(divId,templateName) {
    ...
    mywindow.document.write("<link href='css/components.min.css' rel='stylesheet' type='text/css' />'");
